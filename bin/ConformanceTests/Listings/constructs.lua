...
L25: LOADB R3 0
GETIMPORT R4 13 [tonumber]
LOADK R5 K14 ['1234567890']
CALL R4 1 1
JUMPXEQKN R4 K15 L26 NOT [1234567890]
LOADB R3 1
L26: FASTCALL1 1 R3 L27
GETIMPORT R2 4 [assert]
CALL R2 1 0
   37:  local a; function f(x) x={a=1}; x={x=1}; x={G=1} end
L27: DUPCLOSURE R2 K16 ['f']
SETGLOBAL R2 K17 ['f']
   40: function f (i)
DUPCLOSURE R2 K18 ['f']
SETGLOBAL R2 K17 ['f']
...
GETGLOBAL R5 K10 ['x']
GETTABLEN R4 R5 1
JUMPXEQKN R4 K19 L29 NOT [3]
LOADB R3 0
GETGLOBAL R5 K10 ['x']
GETTABLEN R4 R5 2
JUMPXEQKN R4 K20 L29 NOT [5]
LOADB R3 0
GETGLOBAL R5 K10 ['x']
GETTABLEN R4 R5 3
JUMPXEQKN R4 K21 L29 NOT [10]
LOADB R3 0
GETGLOBAL R5 K10 ['x']
GETTABLEN R4 R5 4
JUMPXEQKN R4 K22 L29 NOT [9]
GETGLOBAL R5 K10 ['x']
GETTABLEN R4 R5 12
JUMPXEQKN R4 K8 L28 [1]
LOADB R3 0 +1
L28: LOADB R3 1
L29: FASTCALL1 1 R3 L30
GETIMPORT R2 4 [assert]
CALL R2 1 0
REMARK builtin assert/1
   47: assert(x[nil] == nil)
L30: GETGLOBAL R5 K10 ['x']
LOADNIL R6
GETTABLE R4 R5 R6
JUMPXEQKNIL R4 L31
LOADB R3 0 +1
L31: LOADB R3 1
L32: FASTCALL1 1 R3 L33
GETIMPORT R2 4 [assert]
CALL R2 1 0
REMARK allocation: table array 3
...
GETGLOBAL R5 K10 ['x']
GETTABLEN R4 R5 1
JUMPXEQKS R4 K23 L35 NOT ['alo']
LOADB R3 0
GETGLOBAL R5 K10 ['x']
GETTABLEN R4 R5 2
JUMPXEQKS R4 K24 L35 NOT ['xixi']
GETGLOBAL R5 K10 ['x']
GETTABLEN R4 R5 3
JUMPXEQKNIL R4 L34
LOADB R3 0 +1
L34: LOADB R3 1
L35: FASTCALL1 1 R3 L36
GETIMPORT R2 4 [assert]
CALL R2 1 0
...
GETGLOBAL R5 K10 ['x']
GETTABLEN R4 R5 1
JUMPXEQKS R4 K25 L37 ['aloxixi']
LOADB R3 0 +1
L37: LOADB R3 1
L38: FASTCALL1 1 R3 L39
GETIMPORT R2 4 [assert]
CALL R2 1 0
REMARK allocation: table array 1
   52: x = {f{}}
...
CALL R4 1 1
L40: JUMPXEQKS R4 K29 L41 ['table']
LOADB R3 0 +1
L41: LOADB R3 1
L42: FASTCALL1 1 R3 L43
GETIMPORT R2 4 [assert]
CALL R2 1 0
   56: local f = function (i)
L43: DUPCLOSURE R2 K30 []
REMARK builtin assert/1
...
LOADN R6 3
CALL R5 1 1
JUMPXEQKS R5 K6 L45 NOT ['a']
LOADB R4 0
MOVE R5 R2
LOADN R6 12
CALL R5 1 1
JUMPXEQKS R5 K7 L45 NOT ['b']
LOADB R4 0
MOVE R5 R2
LOADN R6 26
CALL R5 1 1
JUMPXEQKS R5 K31 L45 NOT ['c']
MOVE R5 R2
LOADN R6 100
CALL R5 1 1
JUMPXEQKNIL R5 L44
...
MUL R6 R7 R8
DIVK R5 R6 K9 [2]
JUMPIFNOTEQ R0 R5 L55
GETGLOBAL R5 K33 ['i']
JUMPXEQKN R5 K19 L54 [3]
LOADB R4 0 +1
L54: LOADB R4 1
...
GETTABLE R5 R6 R7
NOT R4 R5
L57: FASTCALL1 1 R4 L58
GETIMPORT R3 4 [assert]
CALL R3 1 0
   76: function f(b)
L58: DUPCLOSURE R2 K35 ['f']
REMARK builtin assert/1
...
LOADN R6 1
CALL R5 1 1
JUMPXEQKN R5 K21 L60 NOT [10]
LOADB R4 0
MOVE R5 R2
LOADN R6 2
CALL R5 1 1
JUMPXEQKN R5 K36 L60 NOT [20]
LOADB R4 0
MOVE R5 R2
LOADN R6 3
CALL R5 1 1
JUMPXEQKN R5 K37 L60 NOT [30]
MOVE R5 R2
LOADN R6 4
CALL R5 1 1
JUMPXEQKN R5 K38 L59 [12]
LOADB R4 0 +1
L59: LOADB R4 1
L60: FASTCALL1 1 R4 L61
GETIMPORT R3 4 [assert]
CALL R3 1 0
   92: local f = function (i)
L61: DUPCLOSURE R3 K39 []
REMARK builtin assert/1
...
LOADN R7 3
CALL R6 1 1
JUMPXEQKS R6 K6 L63 NOT ['a']
LOADB R5 0
MOVE R6 R3
LOADN R7 12
CALL R6 1 1
JUMPXEQKS R6 K7 L63 NOT ['b']
LOADB R5 0
MOVE R6 R3
LOADN R7 26
CALL R6 1 1
JUMPXEQKS R6 K31 L63 NOT ['c']
MOVE R6 R3
LOADN R7 100
CALL R6 1 1
JUMPXEQKN R6 K40 L62 [8]
LOADB R5 0 +1
L62: LOADB R5 1
L63: FASTCALL1 1 R5 L64
...
GETGLOBAL R9 K10 ['x']
GETTABLEN R8 R9 1
JUMPXEQKN R8 K42 L66 NOT [19]
GETGLOBAL R9 K10 ['x']
GETTABLEN R8 R9 2
JUMPXEQKN R8 K41 L65 [25]
LOADB R7 0 +1
L65: LOADB R7 1
L66: FASTCALL1 1 R7 L67
...
JUMPXEQKN R8 K20 L69 NOT [5]
GETGLOBAL R9 K10 ['x']
GETTABLEKS R8 R9 K6 ['a']
JUMPXEQKN R8 K41 L68 [25]
LOADB R7 0 +1
L68: LOADB R7 1
...
GETGLOBAL R9 K10 ['x']
GETTABLEN R8 R9 1
JUMPXEQKN R8 K8 L71 [1]
LOADB R7 0 +1
L71: LOADB R7 1
L72: FASTCALL1 1 R7 L73
GETIMPORT R6 4 [assert]
CALL R6 1 0
  112: function f(i)
L73: DUPCLOSURE R3 K45 ['f']
  119: function g(i)
DUPCLOSURE R6 K46 ['g']
SETGLOBAL R6 K47 ['g']
  126: f(10); g(10);
...
LOADB R10 0
JUMPXEQKN R6 K8 L75 NOT [1]
LOADB R10 0
JUMPXEQKN R7 K9 L75 NOT [2]
JUMPXEQKN R8 K19 L74 [3]
LOADB R10 0 +1
L74: LOADB R10 1
L75: FASTCALL1 1 R10 L76
...
LOADB R10 0
JUMPXEQKN R6 K8 L78 NOT [1]
LOADB R10 0
JUMPXEQKNIL R7 L78 NOT
JUMPXEQKNIL R8 L77
LOADB R10 0 +1
L77: LOADB R10 1
L78: FASTCALL1 1 R10 L79
GETIMPORT R9 4 [assert]
CALL R9 1 0
...
LOADB R9 0
JUMPXEQKN R6 K8 L81 NOT [1]
JUMPXEQKNIL R7 L80
LOADB R9 0 +1
L80: LOADB R9 1
L81: FASTCALL1 1 R9 L82
GETIMPORT R8 4 [assert]
CALL R8 1 0
REMARK allocation: closure with 1 upvalues
  139: function g() f(); return; end;
L82: NEWCLOSURE R8 P8
CAPTURE REF R3
SETGLOBAL R8 K47 ['g']
REMARK builtin assert/1
  140: assert(g() == nil)
...
LOADB R9 0 +1
L83: LOADB R9 1
L84: FASTCALL1 1 R9 L85
GETIMPORT R8 4 [assert]
CALL R8 1 0
REMARK allocation: closure with 1 upvalues
  141: function g() return nil or f() end
L85: NEWCLOSURE R8 P9
CAPTURE REF R3
SETGLOBAL R8 K47 ['g']
  142: a,b = g()
GETGLOBAL R8 K47 ['g']
...
LOADB R9 0
JUMPXEQKN R6 K8 L87 NOT [1]
JUMPXEQKNIL R7 L86
LOADB R9 0 +1
L86: LOADB R9 1
L87: FASTCALL1 1 R9 L88
GETIMPORT R8 4 [assert]
CALL R8 1 0
  145: print'+';
L88: GETIMPORT R8 1 [print]
LOADK R9 K49 ['+']
CALL R8 1 0
  148: f = [[
LOADK R3 K50 []
...
JUMPXEQKN R10 K8 L89 NOT [1]
GETTABLEKS R9 R6 K7 ['b']
L89: FASTCALL1 1 R9 L90
GETIMPORT R8 4 [assert]
CALL R8 1 0
  158: function g (a,b,c,d,e)
L90: DUPCLOSURE R8 K58 ['g']
SETGLOBAL R8 K47 ['g']
...
LOADN R12 1
CALL R10 2 1
JUMPXEQKB R10 1 L92 NOT
LOADB R9 0
GETGLOBAL R10 K47 ['g']
LOADN R11 2
LOADN R12 1
CALL R10 2 1
JUMPXEQKN R10 K8 L92 NOT [1]
GETGLOBAL R10 K60 ['h']
LOADN R11 2
LOADN R12 1
CALL R10 2 1
JUMPXEQKN R10 K8 L91 [1]
LOADB R9 0 +1
L91: LOADB R9 1
L92: FASTCALL1 1 R9 L93
GETIMPORT R8 4 [assert]
CALL R8 1 0
REMARK builtin assert/1
...
LOADK R13 K6 ['a']
CALL R10 3 1
JUMPXEQKN R10 K8 L95 NOT [1]
GETGLOBAL R10 K60 ['h']
LOADN R11 1
LOADN R12 2
LOADK R13 K6 ['a']
CALL R10 3 1
JUMPXEQKN R10 K8 L94 [1]
LOADB R9 0 +1
L94: LOADB R9 1
L95: FASTCALL1 1 R9 L96
GETIMPORT R8 4 [assert]
CALL R8 1 0
...
LOADK R13 K6 ['a']
CALL R10 3 1
JUMPXEQKNIL R10 L97 NOT
LOADB R9 0 +1
L97: LOADB R9 1
L98: FASTCALL2K 1 R9 K61 L99 ['']
LOADK R10 K61 ['']
GETIMPORT R8 4 [assert]
CALL R8 2 0
REMARK builtin assert/1
...
LOADK R13 K6 ['a']
CALL R10 3 1
JUMPXEQKN R10 K8 L101 NOT [1]
GETGLOBAL R10 K60 ['h']
LOADN R11 1
LOADN R12 2
LOADK R13 K6 ['a']
CALL R10 3 1
JUMPXEQKN R10 K8 L100 [1]
LOADB R9 0 +1
L100: LOADB R9 1
L101: FASTCALL1 1 R9 L102
GETIMPORT R8 4 [assert]
CALL R8 1 0
REMARK builtin assert/1
...
LOADK R15 K10 ['x']
CALL R10 5 1
JUMPXEQKN R10 K8 L103 [1]
LOADB R9 0 +1
L103: LOADB R9 1
L104: FASTCALL1 1 R9 L105
  173: assert(f(1,2,nil,1,'x') == 'x' and g(1,2,nil,1,'x') == 1 and
GETIMPORT R8 4 [assert]
CALL R8 1 0
REMARK builtin assert/1
...
LOADK R15 K10 ['x']
CALL R10 5 1
JUMPXEQKN R10 K62 L106 [0]
LOADB R9 0 +1
L106: LOADB R9 1
L107: FASTCALL1 1 R9 L108
  175: assert(f(1,2,nil,nil,'x') == nil and g(1,2,nil,nil,'x') == 0 and
GETIMPORT R8 4 [assert]
CALL R8 1 0
REMARK builtin assert/1
...
LOADNIL R15
CALL R10 5 1
JUMPXEQKN R10 K62 L109 [0]
LOADB R9 0 +1
L109: LOADB R9 1
L110: FASTCALL1 1 R9 L111
  177: assert(f(1,2,nil,1,nil) == nil and g(1,2,nil,1,nil) == 0 and
GETIMPORT R8 4 [assert]
CALL R8 1 0
REMARK builtin assert/1
...
L111: LOADK R11 K6 ['a']
LOADK R12 K7 ['b']
JUMPIFLT R11 R12 L112
LOADB R10 0 +1
L112: LOADB R10 1
L113: JUMPXEQKB R10 1 L114
LOADB R9 0 +1
L114: LOADB R9 1
L115: FASTCALL1 1 R9 L116
GETIMPORT R8 4 [assert]
CALL R8 1 0
...
REMARK builtin assert/1
GETGLOBAL R10 K10 ['x']
JUMPXEQKB R10 0 L117
LOADB R9 0 +1
L117: LOADB R9 1
L118: FASTCALL1 1 R9 L119
GETIMPORT R8 4 [assert]
CALL R8 1 0
...
REMARK builtin assert/1
GETGLOBAL R10 K10 ['x']
JUMPXEQKS R10 K6 L120 ['a']
LOADB R9 0 +1
L120: LOADB R9 1
L121: FASTCALL1 1 R9 L122
GETIMPORT R8 4 [assert]
CALL R8 1 0
...
REMARK builtin assert/1
  187:   assert(a==2)
JUMPXEQKN R8 K9 L123 [2]
LOADB R10 0 +1
L123: LOADB R10 1
L124: FASTCALL1 1 R10 L125
GETIMPORT R9 4 [assert]
CALL R9 1 0
  190: function F(a)
L125: DUPCLOSURE R8 K63 ['F']
SETGLOBAL R8 K64 ['F']
  195: a,b = F(1)~=nil; assert(a == true and b == nil);
GETGLOBAL R10 K64 ['F']
LOADN R11 1
CALL R10 1 1
JUMPXEQKNIL R10 L126 NOT
LOADB R8 0 +1
L126: LOADB R8 1
L127: LOADNIL R9
MOVE R6 R8
...
REMARK builtin assert/1
LOADB R9 0
JUMPXEQKB R6 1 L129 NOT
JUMPXEQKNIL R7 L128
LOADB R9 0 +1
L128: LOADB R9 1
L129: FASTCALL1 1 R9 L130
GETIMPORT R8 4 [assert]
CALL R8 1 0
  196: a,b = F(nil)==nil; assert(a == true and b == nil)
L130: GETGLOBAL R10 K64 ['F']
LOADNIL R11
CALL R10 1 1
JUMPXEQKNIL R10 L131
LOADB R8 0 +1
L131: LOADB R8 1
L132: LOADNIL R9
MOVE R6 R8
...
REMARK builtin assert/1
LOADB R9 0
JUMPXEQKB R6 1 L134 NOT
JUMPXEQKNIL R7 L133
LOADB R9 0 +1
L133: LOADB R9 1
L134: FASTCALL1 1 R9 L135
GETIMPORT R8 4 [assert]
CALL R8 1 0
  202: function ID(x) return x end
L135: DUPCLOSURE R8 K65 ['ID']
SETGLOBAL R8 K66 ['ID']
  204: function f(t, i)
DUPCLOSURE R3 K67 ['f']
...
NOT R16 R17
GETGLOBAL R17 K80 ['K']
JUMPIFNOTEQ R16 R17 L139
GETGLOBAL R17 K84 ['WX2']
NOT R16 R17
GETGLOBAL R17 K80 ['K']
JUMPIFEQ R16 R17 L138
LOADB R15 0 +1
L138: LOADB R15 1
L139: FASTCALL1 1 R15 L140
GETIMPORT R14 4 [assert]
CALL R14 1 0
  236:   if i%4000 == 0 then print('+') end
L140: MODK R14 R11 K88 [4000]
JUMPXEQKN R14 K62 L141 NOT [0]
GETIMPORT R14 1 [print]
LOADK R15 K49 ['+']
CALL R14 1 0
  237:   i = i+1
L141: ADDK R11 R11 K8 [1]
  238: until i==c
GETGLOBAL R14 K31 ['c']
JUMPIFEQ R11 R14 L142
JUMPBACK L136
  240: print 'OK'
L142: GETIMPORT R12 1 [print]
LOADK R13 K89 ['OK']
CALL R12 1 0
  241: 
CLOSEUPVALS R3
