...
JUMPIFNOT R8 L9
LOADB R8 0
JUMPXEQKNIL R3 L9 NOT
GETIMPORT R9 13 [coroutine.status]
MOVE R10 R0
CALL R9 1 1
JUMPXEQKS R9 K22 L8 ['suspended']
LOADB R8 0 +1
L8: LOADB R8 1
L9: FASTCALL1 1 R8 L10
GETIMPORT R7 7 [assert]
CALL R7 1 0
   45: s,a,b,c,d = coroutine.resume(f)
L10: GETIMPORT R7 11 [coroutine.resume]
MOVE R8 R0
CALL R7 1 5
MOVE R2 R7
MOVE R3 R8
...
L13: GETIMPORT R7 11 [coroutine.resume]
MOVE R8 R0
LOADN R9 1
LOADN R10 2
LOADN R11 3
...
JUMPIFNOT R8 L15
LOADB R8 0
JUMPXEQKS R3 K28 L15 NOT ['a']
LOADB R8 0
JUMPXEQKS R4 K29 L15 NOT ['b']
LOADB R8 0
JUMPXEQKS R5 K30 L15 NOT ['c']
JUMPXEQKNIL R6 L14
LOADB R8 0 +1
L14: LOADB R8 1
L15: FASTCALL1 1 R8 L16
GETIMPORT R7 7 [assert]
CALL R7 1 0
   51: s,a,b,c,d = coroutine.resume(f, "xuxu")
L16: GETIMPORT R7 11 [coroutine.resume]
MOVE R8 R0
LOADK R9 K32 ['xuxu']
CALL R7 2 5
MOVE R2 R7
...
JUMPIFNOT R8 L18
LOADB R8 0
JUMPXEQKN R3 K31 L18 NOT [1]
LOADB R8 0
JUMPXEQKN R4 K33 L18 NOT [2]
LOADB R8 0
JUMPXEQKN R5 K34 L18 NOT [3]
JUMPXEQKNIL R6 L17
LOADB R8 0 +1
L17: LOADB R8 1
L18: FASTCALL1 1 R8 L19
GETIMPORT R7 7 [assert]
CALL R7 1 0
REMARK builtin assert/1
   54: assert(coroutine.status(f) == "dead")
L19: GETIMPORT R9 13 [coroutine.status]
MOVE R10 R0
CALL R9 1 1
JUMPXEQKS R9 K35 L20 ['dead']
LOADB R8 0 +1
L20: LOADB R8 1
L21: FASTCALL1 1 R8 L22
GETIMPORT R7 7 [assert]
CALL R7 1 0
   55: s, a = coroutine.resume(f, "xuxu")
L22: GETIMPORT R7 11 [coroutine.resume]
MOVE R8 R0
LOADK R9 K32 ['xuxu']
CALL R7 2 2
MOVE R2 R7
...
LOADN R9 1
FORNPREP R8 L30
L26: SETGLOBAL R10 K15 ['x']
REMARK builtin assert/1
MOVE R13 R0
MOVE R14 R10
CALL R13 1 1
JUMPIFEQ R13 R10 L27
LOADB R12 0 +1
L27: LOADB R12 1
L28: FASTCALL1 1 R12 L29
GETIMPORT R11 7 [assert]
CALL R11 1 0
L29: FORNLOOP R8 L26
   68: x = 'xuxu'; assert(f('xuxu') == 'a')
L30: LOADK R8 K32 ['xuxu']
SETGLOBAL R8 K15 ['x']
REMARK builtin assert/1
MOVE R10 R0
LOADK R11 K32 ['xuxu']
CALL R10 1 1
JUMPXEQKS R10 K28 L31 ['a']
LOADB R9 0 +1
L31: LOADB R9 1
L32: FASTCALL1 1 R9 L33
GETIMPORT R8 7 [assert]
CALL R8 1 0
   71: function pf (n, i)
L33: DUPCLOSURE R8 K39 ['pf']
SETGLOBAL R8 K40 ['pf']
...
FASTCALL2 52 R10 R11 L40
MOVE R13 R10
MOVE R14 R11
GETIMPORT R12 47 [table.insert]
CALL R12 2 0
  107:   x = filter(n, x)
L40: GETGLOBAL R12 K44 ['filter']
MOVE R13 R11
MOVE R14 R9
CALL R12 2 1
MOVE R9 R12
...
L41: LOADB R12 0
LENGTH R13 R10
JUMPXEQKN R13 K48 L43 NOT [22]
LENGTH R14 R10
GETTABLE R13 R10 R14
JUMPXEQKN R13 K49 L42 [79]
LOADB R12 0 +1
L42: LOADB R12 1
L43: FASTCALL1 1 R12 L44
GETIMPORT R11 7 [assert]
CALL R11 1 0
  111: x, a = nil
L44: LOADNIL R11
...
CALL R13 0 1
JUMPXEQKN R13 K52 L45 [20]
LOADB R12 0 +1
L45: LOADB R12 1
L46: FASTCALL1 1 R12 L47
GETIMPORT R11 7 [assert]
CALL R11 1 0
REMARK builtin assert/1
  124: assert(co() == 30)
L47: GETGLOBAL R13 K51 ['co']
CALL R13 0 1
JUMPXEQKN R13 K53 L48 [30]
LOADB R12 0 +1
L48: LOADB R12 1
L49: FASTCALL1 1 R12 L50
GETIMPORT R11 7 [assert]
CALL R11 1 0
  128:   local function f (c)
L50: DUPCLOSURE R11 K54 ['f']
...
MOVE R15 R12
CALL R15 0 1
JUMPXEQKS R15 K56 L51 ['aa']
LOADB R14 0 +1
L51: LOADB R14 1
L52: FASTCALL1 1 R14 L53
GETIMPORT R13 7 [assert]
CALL R13 1 0
REMARK allocation: closure with 1 upvalues
  144: function foo ()
L53: NEWCLOSURE R7 P10
CAPTURE REF R7
REMARK allocation: closure with 1 upvalues
  149: function goo() foo() end
NEWCLOSURE R11 P11
...
MOVE R13 R9
CALL R13 0 1
JUMPXEQKN R13 K34 L54 [3]
LOADB R12 0 +1
L54: LOADB R12 1
L55: FASTCALL1 1 R12 L56
GETIMPORT R11 7 [assert]
CALL R11 1 0
  152: local a,b = pcall(x)
L56: GETIMPORT R11 9 [pcall]
MOVE R12 R9
CALL R11 1 2
REMARK builtin assert/1
...
LOADB R14 0 +1
L57: LOADB R14 1
L58: FASTCALL1 1 R14 L59
GETIMPORT R13 7 [assert]
CALL R13 1 0
  155: x = coroutine.create(goo)
L59: GETIMPORT R13 18 [coroutine.create]
...
MOVE R14 R11
JUMPIFNOT R14 L61
JUMPXEQKN R12 K34 L60 [3]
LOADB R14 0 +1
L60: LOADB R14 1
L61: FASTCALL1 1 R14 L62
GETIMPORT R13 7 [assert]
CALL R13 1 0
  158: a,b = coroutine.resume(x)
L62: GETIMPORT R13 11 [coroutine.resume]
MOVE R14 R9
CALL R13 1 2
MOVE R11 R13
MOVE R12 R14
...
JUMPIFNOT R14 L64
LOADB R14 0
JUMPIFNOTEQ R12 R7 L64
GETIMPORT R15 13 [coroutine.status]
MOVE R16 R9
CALL R15 1 1
JUMPXEQKS R15 K35 L63 ['dead']
LOADB R14 0 +1
L63: LOADB R14 1
L64: FASTCALL1 1 R14 L65
GETIMPORT R13 7 [assert]
CALL R13 1 0
  160: a,b = coroutine.resume(x)
L65: GETIMPORT R13 11 [coroutine.resume]
MOVE R14 R9
CALL R13 1 2
MOVE R11 R13
MOVE R12 R14
...
MOVE R16 R9
CALL R15 1 1
JUMPXEQKS R15 K35 L66 ['dead']
LOADB R14 0 +1
L66: LOADB R14 1
L67: FASTCALL1 1 R14 L68
GETIMPORT R13 7 [assert]
CALL R13 1 0
  165: function all (a, n, k)
L68: DUPCLOSURE R13 K58 ['all']
...
MOVE R19 R16
CALL R19 0 1
JUMPXEQKN R19 K68 L76 NOT [21]
LOADB R18 0
MOVE R19 R15
CALL R19 0 1
CALL R19 0 1
JUMPXEQKN R19 K69 L76 NOT [32]
MOVE R19 R15
CALL R19 0 1
JUMPIFEQ R19 R16 L75
LOADB R18 0 +1
L75: LOADB R18 1
L76: FASTCALL1 1 R18 L77
...
JUMPIFEQ R19 R20 L78
LOADB R18 0 +1
L78: LOADB R18 1
L79: FASTCALL1 1 R18 L80
GETIMPORT R17 7 [assert]
CALL R17 1 0
REMARK builtin assert/1
...
MOVE R19 R16
CALL R19 0 1
JUMPXEQKN R19 K74 L82 NOT [43]
MOVE R19 R16
CALL R19 0 1
JUMPXEQKN R19 K75 L81 [53]
LOADB R18 0 +1
L81: LOADB R18 1
L82: FASTCALL1 1 R18 L83
GETIMPORT R17 7 [assert]
CALL R17 1 0
  205: function co_func (current_co)
L83: DUPCLOSURE R17 K76 ['co_func']
...
LOADB R22 0
JUMPXEQKB R18 1 L85 NOT
LOADB R22 0
JUMPXEQKN R19 K78 L85 NOT [10]
JUMPXEQKN R20 K52 L84 [20]
LOADB R22 0 +1
L84: LOADB R22 1
L85: FASTCALL1 1 R22 L86
GETIMPORT R21 7 [assert]
CALL R21 1 0
  217: a,b = coroutine.resume(co, co)
L86: GETIMPORT R21 11 [coroutine.resume]
MOVE R22 R17
MOVE R23 R17
CALL R21 2 2
MOVE R18 R21
...
LOADB R22 0
JUMPXEQKB R18 1 L88 NOT
JUMPXEQKN R19 K79 L87 [23]
LOADB R22 0 +1
L87: LOADB R22 1
L88: FASTCALL1 1 R22 L89
GETIMPORT R21 7 [assert]
CALL R21 1 0
  219: a,b = coroutine.resume(co, co)
L89: GETIMPORT R21 11 [coroutine.resume]
MOVE R22 R17
MOVE R23 R17
CALL R21 2 2
MOVE R18 R21
...
LOADB R22 0
JUMPXEQKB R18 1 L91 NOT
JUMPXEQKN R19 K78 L90 [10]
LOADB R22 0 +1
L90: LOADB R22 1
L91: FASTCALL1 1 R22 L92
GETIMPORT R21 7 [assert]
CALL R21 1 0
REMARK builtin assert/1
  221: assert(coroutine.resume(co, co) == false)
L92: GETIMPORT R23 11 [coroutine.resume]
MOVE R24 R17
MOVE R25 R17
CALL R23 2 1
JUMPXEQKB R23 0 L93
LOADB R22 0 +1
L93: LOADB R22 1
L94: FASTCALL1 1 R22 L95
GETIMPORT R21 7 [assert]
CALL R21 1 0
REMARK builtin assert/1
  222: assert(coroutine.resume(co, co) == false)
L95: GETIMPORT R23 11 [coroutine.resume]
MOVE R24 R17
MOVE R25 R17
CALL R23 2 1
JUMPXEQKB R23 0 L96
...
MOVE R24 R18
JUMPIFNOT R24 L100
JUMPXEQKN R19 K34 L99 [3]
LOADB R24 0 +1
L99: LOADB R24 1
L100: FASTCALL1 1 R24 L101
GETIMPORT R23 7 [assert]
CALL R23 1 0
REMARK builtin assert/1
  236: assert(coroutine.status(co1) == 'dead')
L101: GETIMPORT R25 13 [coroutine.status]
MOVE R26 R21
CALL R25 1 1
JUMPXEQKS R25 K35 L102 ['dead']
LOADB R24 0 +1
L102: LOADB R24 1
L103: FASTCALL1 1 R24 L104
GETIMPORT R23 7 [assert]
CALL R23 1 0
  238: if not limitedstack then
L104: GETIMPORT R23 81 [limitedstack]
JUMPIF R23 L106
  240:   a = function(a) coroutine.wrap(a)(a) end
DUPCLOSURE R18 K82 []
REMARK builtin assert/1
...
CALL R25 2 1
NOT R24 R25
FASTCALL1 1 R24 L105
GETIMPORT R23 7 [assert]
CALL R23 1 0
  242:   a = nil
L105: LOADNIL R18
  246: local x = coroutine.create (function ()
L106: GETIMPORT R23 18 [coroutine.create]
REMARK allocation: closure with 1 upvalues
NEWCLOSURE R24 P19
CAPTURE REF R16
CALL R23 1 1
...
L108: MOVE R26 R16
CALL R26 0 1
JUMPXEQKN R26 K83 L109 [11]
LOADB R25 0 +1
L109: LOADB R25 1
L110: FASTCALL1 1 R25 L111
GETIMPORT R24 7 [assert]
CALL R24 1 0
REMARK builtin assert/1
  256: assert(f() == 12)
L111: MOVE R26 R16
CALL R26 0 1
JUMPXEQKN R26 K84 L112 [12]
LOADB R25 0 +1
L112: LOADB R25 1
L113: FASTCALL1 1 R25 L114
GETIMPORT R24 7 [assert]
CALL R24 1 0
  259: _X = coroutine.wrap(function ()
L114: GETIMPORT R24 38 [coroutine.wrap]
DUPCLOSURE R25 K85 []
CALL R24 1 1
...
MOVE R28 R24
CALL R27 1 1
JUMPXEQKS R27 K22 L115 ['suspended']
LOADB R26 0 +1
L115: LOADB R26 1
L116: FASTCALL1 1 R26 L117
GETIMPORT R25 7 [assert]
CALL R25 1 0
  271: coroutine.resume(co)
L117: GETIMPORT R25 11 [coroutine.resume]
MOVE R26 R24
CALL R25 1 0
REMARK builtin assert/1
...
MOVE R28 R24
CALL R27 1 1
JUMPXEQKS R27 K22 L118 ['suspended']
LOADB R26 0 +1
L118: LOADB R26 1
L119: FASTCALL1 1 R26 L120
GETIMPORT R25 7 [assert]
CALL R25 1 0
  273: coroutine.resume(co)
L120: GETIMPORT R25 11 [coroutine.resume]
MOVE R26 R24
CALL R25 1 0
REMARK builtin assert/1
...
MOVE R28 R24
CALL R27 1 1
JUMPXEQKS R27 K35 L121 ['dead']
LOADB R26 0 +1
L121: LOADB R26 1
L122: FASTCALL1 1 R26 L123
GETIMPORT R25 7 [assert]
CALL R25 1 0
  277: for i=0,30 do
L123: LOADN R27 0
...
L124: GETIMPORT R28 89 [table.create]
MOVE R29 R27
LOADN R30 42
CALL R28 2 1
  279:   local co = coroutine.create(function() coroutine.yield(table.unpack(T)) end)
...
GETTABLEN R33 R30 1
JUMPXEQKB R33 1 L125
LOADB R32 0 +1
L125: LOADB R32 1
L126: FASTCALL1 1 R32 L127
...
ADD R33 R34 R35
LENGTH R34 R30
JUMPIFEQ R33 R34 L128
LOADB R32 0 +1
L128: LOADB R32 1
L129: FASTCALL1 1 R32 L130
GETIMPORT R31 7 [assert]
CALL R31 1 0
REMARK builtin assert/1
...
L130: LOADB R32 1
LENGTH R33 R30
JUMPXEQKN R33 K31 L132 [1]
LENGTH R34 R30
GETTABLE R33 R30 R34
JUMPXEQKN R33 K92 L131 [42]
LOADB R32 0 +1
L131: LOADB R32 1
L132: FASTCALL1 1 R32 L133
GETIMPORT R31 7 [assert]
CALL R31 1 0
  277: for i=0,30 do
L133: FORNLOOP R25 L124
  289:   local co = coroutine.create(type)
L134: GETIMPORT R25 18 [coroutine.create]
...
L135: GETIMPORT R28 13 [coroutine.status]
MOVE R29 R25
CALL R28 1 1
JUMPXEQKS R28 K35 L136 ['dead']
LOADB R27 0 +1
L136: LOADB R27 1
L137: FASTCALL1 1 R27 L138
GETIMPORT R26 7 [assert]
CALL R26 1 0
  292:   local st, msg = coroutine.close(co)
L138: GETIMPORT R26 95 [coroutine.close]
MOVE R27 R25
CALL R26 1 2
REMARK builtin assert/1
...
MOVE R29 R26
JUMPIFNOT R29 L140
JUMPXEQKNIL R27 L139
LOADB R29 0 +1
L139: LOADB R29 1
L140: FASTCALL1 1 R29 L141
GETIMPORT R28 7 [assert]
CALL R28 1 0
  295:   st, msg = coroutine.close(co)
L141: GETIMPORT R28 95 [coroutine.close]
MOVE R29 R25
CALL R28 1 2
MOVE R26 R28
MOVE R27 R29
...
MOVE R29 R26
JUMPIFNOT R29 L143
JUMPXEQKNIL R27 L142
LOADB R29 0 +1
L142: LOADB R29 1
L143: FASTCALL1 1 R29 L144
GETIMPORT R28 7 [assert]
CALL R28 1 0
  300:   coroutine.wrap(function()
L144: GETIMPORT R28 38 [coroutine.wrap]
DUPCLOSURE R29 K96 []
CALL R28 1 1
  303:   end)()
CALL R28 0 0
...
NOT R33 R30
JUMPIFNOT R33 L146
JUMPIFEQ R31 R29 L145
LOADB R33 0 +1
L145: LOADB R33 1
L146: FASTCALL1 1 R33 L147
GETIMPORT R32 7 [assert]
CALL R32 1 0
  319:   st, msg = coroutine.close(co)
L147: GETIMPORT R32 95 [coroutine.close]
MOVE R33 R28
CALL R32 1 2
MOVE R30 R32
MOVE R31 R33
...
NOT R33 R30
JUMPIFNOT R33 L149
JUMPIFEQ R31 R29 L148
LOADB R33 0 +1
L148: LOADB R33 1
L149: FASTCALL1 1 R33 L150
GETIMPORT R32 7 [assert]
CALL R32 1 0
  322:   st, msg = coroutine.close(co)
L150: GETIMPORT R32 95 [coroutine.close]
MOVE R33 R28
CALL R32 1 2
MOVE R30 R32
MOVE R31 R33
...
MOVE R33 R30
JUMPIFNOT R33 L152
JUMPXEQKNIL R31 L151
LOADB R33 0 +1
L151: LOADB R33 1
L152: FASTCALL1 1 R33 L153
GETIMPORT R32 7 [assert]
CALL R32 1 0
  326:   local f
L153: LOADNIL R32
...
MOVE R36 R32
CALL R36 0 1
JUMPXEQKN R36 K92 L154 [42]
LOADB R35 0 +1
L154: LOADB R35 1
L155: FASTCALL1 1 R35 L156
GETIMPORT R34 7 [assert]
CALL R34 1 0
  335:   st, msg = coroutine.close(co)
L156: GETIMPORT R34 95 [coroutine.close]
MOVE R35 R33
CALL R34 1 2
MOVE R30 R34
MOVE R31 R35
...
MOVE R35 R30
JUMPIFNOT R35 L158
JUMPXEQKNIL R31 L157
LOADB R35 0 +1
L157: LOADB R35 1
L158: FASTCALL1 1 R35 L159
GETIMPORT R34 7 [assert]
CALL R34 1 0
REMARK builtin assert/1
  337:   assert(f() == 42)
L159: MOVE R36 R32
CALL R36 0 1
JUMPXEQKN R36 K92 L160 [42]
LOADB R35 0 +1
L160: LOADB R35 1
L161: FASTCALL1 1 R35 L162
GETIMPORT R34 7 [assert]
CALL R34 1 0
  340:   co = coroutine.create(function()
L162: GETIMPORT R34 18 [coroutine.create]
DUPCLOSURE R35 K100 []
CALL R34 1 1
MOVE R33 R34
REMARK builtin assert/1+
...
L163: GETIMPORT R34 95 [coroutine.close]
MOVE R35 R33
CALL R34 1 2
MOVE R30 R34
MOVE R31 R35
...
MOVE R35 R30
JUMPIFNOT R35 L165
JUMPXEQKNIL R31 L164
LOADB R35 0 +1
L164: LOADB R35 1
L165: FASTCALL1 1 R35 L166
GETIMPORT R34 7 [assert]
CALL R34 1 0
L166: CLOSEUPVALS R32
  349: print 'OK'
