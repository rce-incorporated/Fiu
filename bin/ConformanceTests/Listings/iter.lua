...
CONCAT R0 R6 R7
  147:   for k, v in {1, 2, 3, nil, 5} do
L106: FORGLOOP R1 L105 2
REMARK builtin assert/1
  150:   assert(x == "1235")
JUMPXEQKS R0 K51 L107 ['1235']
LOADB R2 0 +1
L107: LOADB R2 1
...
L110: ADD R0 R0 R5
  156:   for k, v in {1, 2, 3, nil, 5, a = 1, b = 2, c = 3} do
L111: FORGLOOP R1 L110 2
REMARK builtin assert/1
  159:   assert(x == 17)
JUMPXEQKN R0 K52 L112 [17]
LOADB R2 0 +1
L112: LOADB R2 1
L113: FASTCALL1 1 R2 L114
GETIMPORT R1 9 [assert]
CALL R1 1 0
  164:   local ok, err = pcall(function() for x in 42 do end end)
L114: GETIMPORT R0 54 [pcall]
DUPCLOSURE R1 K55 []
CALL R0 1 2
REMARK builtin assert/1
...
CALL R3 2 1
L115: FASTCALL1 1 R3 L116
GETIMPORT R2 9 [assert]
CALL R2 1 0
REMARK allocation: table hash 0
  170:   local obj = {}
L116: NEWTABLE R0 0 0
REMARK builtin setmetatable/2
REMARK allocation: table template 1
  171:   setmetatable(obj, { __iter = function() end })
DUPTABLE R3 45
...
SETTABLEKS R4 R3 K44 ['__iter']
FASTCALL2 61 R0 R3 L117
MOVE R2 R0
GETIMPORT R1 31 [setmetatable]
CALL R1 2 0
  173:   local ok, err = pcall(function() for x in obj do end end)
L117: GETIMPORT R1 54 [pcall]
DUPCLOSURE R2 K59 []
CAPTURE VAL R0
CALL R1 1 2
REMARK builtin assert/1
...
L120: ADD R0 R0 R4
  180:   for k in {1, 2, 3, 4, 5} do
L121: FORGLOOP R1 L120 1
REMARK builtin assert/1
  183:   assert(x == 15)
JUMPXEQKN R0 K61 L122 [15]
LOADB R2 0 +1
L122: LOADB R2 1
...
LOADB R12 0
JUMPXEQKNIL R6 L127 NOT
LOADB R12 0
JUMPXEQKNIL R7 L127 NOT
LOADB R12 0
JUMPXEQKNIL R8 L127 NOT
LOADB R12 0
JUMPXEQKNIL R9 L127 NOT
JUMPXEQKNIL R10 L126
LOADB R12 0 +1
L126: LOADB R12 1
L127: FASTCALL1 1 R12 L128
GETIMPORT R11 9 [assert]
CALL R11 1 0
  189:   for k,v,a,b,c,d,e in {1, 2, 3, 4, 5} do
L128: FORGLOOP R1 L125 7
REMARK builtin assert/1
  193:   assert(x == 15)
JUMPXEQKN R0 K61 L129 [15]
LOADB R2 0 +1
L129: LOADB R2 1
...
L131: DUPCLOSURE R0 K62 ['testgetfenv']
