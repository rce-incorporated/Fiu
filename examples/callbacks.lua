...
luau_settings.callHooks.interruptHook = function(stack, debugging, proto, module, upvals)
	...
	stack[proto.code[debugging.pc].A] = function() error("This function was placed by the interrupt hook!") end
end
...
local luau_execute = Fiu.luau_load(Bytecode, {}, luau_settings)
luau_execute()
