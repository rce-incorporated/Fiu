...
assert(a == '�lo alo' and b == '�l' and c == '�' and d == 'alo' and e == nil, `{a}, {b}, {c}, {d}, {e}`)
...
t = "ab� d"
a, b = string.gsub(t, '(.)', '%1@')
assert('@'..a == string.gsub(t, '', '@') and b == 7)
...
do
  local function setglobal (n,v) rawset(getfenv(0), n, v) end
  string.gsub("a=roberto,roberto=a", "(%w+)=(%w%w*)", setglobal)
  assert(getfenv(0).a=="roberto" and getfenv(0).roberto=="a")
end
...
local env = getfenv();
local function dostring (s) return setfenv(loadstring(s), env)() or "" end
